        ...
        case MOTOR_FRAME_OCTA:
            switch (frame_type) {
                ...
                case MOTOR_FRAME_TYPE_I:
                    add_motor_raw(AP_MOTORS_MOT_1, -0.333f,  1.0f, AP_MOTORS_MATRIX_YAW_FACTOR_CCW,  1);
                    ...
                    add_motor_raw(AP_MOTORS_MOT_4, -0.333f, -1.0f, AP_MOTORS_MATRIX_YAW_FACTOR_CW, 4);
                    add_motor_raw(AP_MOTORS_MOT_5,  0.333f,  1.0f, AP_MOTORS_MATRIX_YAW_FACTOR_CW, 8);
                    ...
                    add_motor_raw(AP_MOTORS_MOT_8,   -1.0f, -1.0f, AP_MOTORS_MATRIX_YAW_FACTOR_CCW,  3);
                    break;
                case MOTOR_FRAME_TYPE_DJI_X:
